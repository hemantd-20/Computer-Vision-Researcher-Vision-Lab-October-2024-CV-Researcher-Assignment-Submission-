...
class DINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets:List=None):
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal, _, cross_attn_weights = \
            self.transformer(srcs, masks, input_query_bbox, poss, input_query_label, attn_mask)
        ...
        # Add cross-attention weights to the output dictionary for visualization
